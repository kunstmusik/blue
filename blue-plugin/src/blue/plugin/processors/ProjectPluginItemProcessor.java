...
@SupportedAnnotationTypes("blue.plugin.ProjectPluginItem")
@SupportedSourceVersion(SourceVersion.RELEASE_8)
public class ProjectPluginItemProcessor extends LayerGeneratingProcessor {
    ...
    protected boolean handleProcess(Set<? extends TypeElement> set, RoundEnvironment env)
        ...
        for (Element e : env.getElementsAnnotatedWith(ProjectPluginItem.class)) {
            ...
            ProjectPluginItem ppePlugin = 
                    clazz.getAnnotation(ProjectPluginItem.class);
            File f = layer(e).file(
                    "blue/project/plugins/" + teName.replace('.', '-') + ".instance")
