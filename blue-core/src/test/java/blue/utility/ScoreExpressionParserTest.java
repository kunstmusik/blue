...
public class ScoreExpressionParserTest extends TestCase {
    ...
    public void testEval() {             
        ...
        assertEquals(2.0f, ScoreExpressionParser.eval("1+ 1+2 -2"), .0001);
        assertEquals(8.6f, ScoreExpressionParser.eval("((1+5)*2) - 3.4"), .0001);

        assertEquals(4.0f, ScoreExpressionParser.eval("2^2"), .0001);

        assertEquals(216.0f, ScoreExpressionParser.eval("((5 % 3) * 3)^3"),
                .0001);
    }
