 ...
 * @author stevenyi
 */
public class BSBFileSelectorBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( blue.orchestra.blueSynthBuilder.BSBFileSelector.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_textFieldWidth] = new PropertyDescriptor ( "textFieldWidth", blue.orchestra.blueSynthBuilder.BSBFileSelector.class, "getTextFieldWidth", "setTextFieldWidth" ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", blue.orchestra.blueSynthBuilder.BSBFileSelector.class, "getX", "setX" ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", blue.orchestra.blueSynthBuilder.BSBFileSelector.class, "getY", "setY" ); // NOI18N
        }
