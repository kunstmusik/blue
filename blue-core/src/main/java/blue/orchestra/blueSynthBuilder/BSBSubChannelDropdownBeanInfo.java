 ...
 * @author stevenyi
 */
public class BSBSubChannelDropdownBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( blue.orchestra.blueSynthBuilder.BSBSubChannelDropdown.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
