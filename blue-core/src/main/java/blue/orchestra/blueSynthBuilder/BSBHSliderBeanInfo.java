 ...
 * @author stevenyi
 */
public class BSBHSliderBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( blue.orchestra.blueSynthBuilder.BSBHSlider.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_value] = new PropertyDescriptor ( "value", blue.orchestra.blueSynthBuilder.BSBHSlider.class, "getValue", "setValue" ); // NOI18N
