 ...
 * @author stevenyi
 */
public class BSBGroupBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( blue.orchestra.blueSynthBuilder.BSBGroup.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_font = 3;
    private static final int PROPERTY_groupName = 4;
    private static final int PROPERTY_labelTextColor = 5;
    private static final int PROPERTY_titleEnabled = 6;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", blue.orchestra.blueSynthBuilder.BSBGroup.class, "getFont", "setFont" ); // NOI18N
