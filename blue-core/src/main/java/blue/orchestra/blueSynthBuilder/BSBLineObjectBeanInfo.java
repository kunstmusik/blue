 ...
 * @author stevenyi
 */
public class BSBLineObjectBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( blue.orchestra.blueSynthBuilder.BSBLineObject.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_objectName] = new PropertyDescriptor ( "objectName", blue.orchestra.blueSynthBuilder.BSBLineObject.class, "getObjectName", "setObjectName" ); // NOI18N
            properties[PROPERTY_relativeXValues] = new PropertyDescriptor ( "relativeXValues", blue.orchestra.blueSynthBuilder.BSBLineObject.class, "isRelativeXValues", "setRelativeXValues" ); // NOI18N
            properties[PROPERTY_separatorType] = new PropertyDescriptor ( "separatorType", blue.orchestra.blueSynthBuilder.BSBLineObject.class, "getSeparatorType", "setSeparatorType" ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", blue.orchestra.blueSynthBuilder.BSBLineObject.class, "getX", "setX" ); // NOI18N
            properties[PROPERTY_XMax] = new PropertyDescriptor ( "XMax", blue.orchestra.blueSynthBuilder.BSBLineObject.class, "getXMax", "setXMax" ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", blue.orchestra.blueSynthBuilder.BSBLineObject.class, "getY", "setY" ); // NOI18N
        }
