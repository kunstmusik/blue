 ...
 * @author stevenyi
 */
public class BSBDropdownBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( blue.orchestra.blueSynthBuilder.BSBDropdown.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
