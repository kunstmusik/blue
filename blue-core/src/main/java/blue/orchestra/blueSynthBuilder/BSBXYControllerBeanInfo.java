 ...
 * @author stevenyi
 */
public class BSBXYControllerBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( blue.orchestra.blueSynthBuilder.BSBXYController.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_YMax] = new PropertyDescriptor ( "YMax", blue.orchestra.blueSynthBuilder.BSBXYController.class, "getYMax", "setYMax" ); // NOI18N
            properties[PROPERTY_YMin] = new PropertyDescriptor ( "YMin", blue.orchestra.blueSynthBuilder.BSBXYController.class, "getYMin", "setYMin" ); // NOI18N
        }
