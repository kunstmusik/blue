 ...
 * @author stevenyi
 */
public class BSBVSliderBankBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( blue.orchestra.blueSynthBuilder.BSBVSliderBank.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_numberOfSliders] = new PropertyDescriptor ( "numberOfSliders", blue.orchestra.blueSynthBuilder.BSBVSliderBank.class, "getNumberOfSliders", "setNumberOfSliders" ); // NOI18N
            properties[PROPERTY_objectName] = new PropertyDescriptor ( "objectName", blue.orchestra.blueSynthBuilder.BSBVSliderBank.class, "getObjectName", "setObjectName" ); // NOI18N
