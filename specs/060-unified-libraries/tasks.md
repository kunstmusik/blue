...
- [X] T032 [US1] Keep the workbench mounted without a project and render a project-independent Welcome surface while preserving current project panel behavior in `packages/blue-app/src/renderer/components/workbench/WorkbenchShell.tsx`, `packages/blue-app/src/renderer/components/workbench/panels/WelcomePanel.tsx`, and `packages/blue-app/src/renderer/App.tsx`.
