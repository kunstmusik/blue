...
- Release readiness still requires the explicitly documented live Electron visual/interaction smoke for narrow, docked, minimized, floating, and restored layouts; this manual-only check is not conflated with headless verification.
