...
| V06 | 800×600, Csound / Post Code | The CodeMirror editor grows to the available panel height rather than remaining in the old fixed-height box; syntax highlighting remains active. |
| V07 | Csound / top-level tab switch | Post Code remains mounted with its content intact after switching away and back; no obsolete nested Csound tabs are shown and the outer editor geometry remains stable. |
