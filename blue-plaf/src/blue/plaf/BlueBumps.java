...
class BlueBumps implements Icon {
    ...
    public BlueBumps(Dimension bumpArea) {
        this(bumpArea.width, bumpArea.height);
    }

    public BlueBumps(int width, int height) {
        this(width, height, BlueLookAndFeel.getPrimaryControlHighlight(),
                BlueLookAndFeel.getPrimaryControlDarkShadow(), BlueLookAndFeel
                        .getPrimaryControlShadow());
    }

    public BlueBumps(int width, int height, Color newTopColor,
