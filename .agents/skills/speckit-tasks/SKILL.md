...
2. **From Contracts**:
   ...
   - Each affected interface contract → contract test task [P] before implementation when required by the constitution or plan
...
- **Phase 3+**: User Stories in priority order (P1, P2, P3...)
  - Within each story: Required verification → Models → Services → Endpoints → Integration
