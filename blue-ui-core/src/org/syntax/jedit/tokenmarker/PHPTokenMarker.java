 ...
 * @version $Id: PHPTokenMarker.java,v 1.4 2007-10-27 00:17:17 kunstmusik Exp $
 */
                ...
                case Token.NULL: // HTML text
                    ...
                    switch (c) {
                        case '<':
                            ...
                            } else if (SyntaxUtilities.regionMatches(true,
                                    line, i1, "?php")) {
                    ...
                    switch (c) {
                        ...
                        default:
                            ...
                            if (!Character.isLetterOrDigit(c) && c != '_'
                                ...
                                doKeyword(line, i, c);
                                if (c != ' ') {
                                    // assume non alphanumeric characters are
                                    // operators
                                    addToken(i - lastOffset, Token.KEYWORD3);
                                    addToken(1, Token.OPERATOR);
                                    lastOffset = lastKeyword = i1;
