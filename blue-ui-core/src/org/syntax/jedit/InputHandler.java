 ...
 * 
 * @author Slava Pestov
 * @version $Id: InputHandler.java,v 1.6 2007-10-27 00:17:23 kunstmusik Exp $
...
public abstract class InputHandler extends KeyAdapter {
    ...
    public static final ActionListener INSERT_SHIFT_TAB = new insert_shift_tab();
    ...
    static {
        ...
        actions.put("insert-shift-tab", INSERT_SHIFT_TAB);
    ...
    public static class insert_shift_tab implements ActionListener {
        public void actionPerformed(ActionEvent evt) {
            JEditTextArea textArea = getTextArea(evt);
