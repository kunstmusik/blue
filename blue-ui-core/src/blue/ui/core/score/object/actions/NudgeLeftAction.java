...
@ActionID(
        category = "Blue",
        id = "blue.ui.core.score.object.actions.NudgeLeftAction"
)
@ActionRegistration(
        displayName = "#CTL_NudgeLeftAction"
)
@Messages("CTL_NudgeLeftAction=NudgeLeftAction")
@ActionReference(path = "blue/score/shortcuts", name = "LEFT")
public final class NudgeLeftAction implements ActionListener {
