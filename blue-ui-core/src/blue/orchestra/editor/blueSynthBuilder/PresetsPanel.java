...
public class PresetsPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        managePresetsButton = new javax.swing.JButton();
        ...
        managePresetsButton.setText(org.openide.util.NbBundle.getMessage(PresetsPanel.class, "PresetsPanel.managePresetsButton.text")); // NOI18N
        ...
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 0);
        add(managePresetsButton, gridBagConstraints);
    ...
    private void setPresetsMenu(PresetGroup pGroup, JMenu menu) {
        ...
        for (Iterator iter = pGroup.getSubGroups().iterator(); iter.hasNext();) {
            PresetGroup subGroup = (PresetGroup) iter.next();
        ...
        for (Iterator iter = pGroup.getPresets().iterator(); iter.hasNext();) {
            Preset preset = (Preset) iter.next();
    ...
    private javax.swing.JButton managePresetsButton;
