...
public class EffectImportPane extends JComponent {
    ...
    private String AVAILABLE_INSTRUMENTS_LABEL = BlueSystem
            .getString("blueShare.effect.availableEffects");
    ...
    private void jbInit() throws Exception {
        ...
        iNameLabel.setText(BlueSystem
                .getString("blueShare.effect.effectNameLabel"));
        ...
        importButton.setText(BlueSystem
                .getString("blueShare.effect.importEffect"));
        ...
        JLabel tempLabel = new JLabel(BlueSystem
                .getString("blueShare.effect.noEffectsForCategory"));
        ...
        tempLabel = new JLabel(BlueSystem
                .getString("blueShare.effect.selectEffect"));
        tempLabel.setHorizontalAlignment(SwingConstants.CENTER);
        ...
        categoryTree.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    BlueShareEffectCategory tempCat = (BlueShareEffectCategory) tempNode
                            .getUserObject();
    ...
    private void importEffect() {
        EffectOption effectOption = iTableModel
        ...
        try {
            ...
            if (effect == null) {
                String error = BlueSystem
                        .getString("blueShare.effect.importError");
                JOptionPane.showMessageDialog(null, error, BlueSystem
                        .getString("message.error"), JOptionPane.ERROR_MESSAGE);
                return;
            ...
            String message = BlueSystem
                    .getString("blueShare.effect.importSuccess");
    ...
    public void setCategories(BlueShareEffectCategory[] categories) {
        ...
        BlueShareEffectCategory latestInstruments = new BlueShareEffectCategory(
                Integer.MIN_VALUE, ">Latest Effects",
                "Newest Effects in Repository", null);
