 ...
 * 
 */
final class SoundObjectManagementTableModel extends AbstractTableModel {
    SoundObjectOption[] iOptions;

    public SoundObjectManagementTableModel() {
    }

    public void setSoundObjectOptions(SoundObjectOption[] iOptions) {
        this.iOptions = iOptions;
        fireTableDataChanged();
    }

    public SoundObjectOption getSoundObjectOption(int index) {
    ...
    public String getColumnName(int i) {
        if (i == 0) {
            ...
            return BlueSystem.getString("common.category");
        }
        return null;
    }
