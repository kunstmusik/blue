...
public class PythonInstrumentEditor extends InstrumentEditor {
    ...
    public final void editInstrument(Instrument instr) {
        ...
        if (!(instr instanceof PythonInstrument)) {
            this.instr = null;
            editorLabel.setText(BlueSystem
                    .getString("instrument.noEditorAvailable"));
            codeEditor
...
//        }
        this.instr = (PythonInstrument) instr;
    ...
    private void initComponents() {
        ...
        editorLabel.setText("Python Instrument");
