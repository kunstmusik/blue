...
public class BSBFileSelectorView extends BSBObjectView<BSBFileSelector> {
    ...
    public String getToolTipText() {
        return shouldShowToolTip() ? getBSBObject().getComment() : null;
    }
    
    protected void updateDisplay() {
        fileNameField.setText(getBSBObject().getFileName());
    }

    public int getTextFieldWidth() {
        return getBSBObject().getTextFieldWidth();
    }
    ...
    public void setTextFieldWidth(int textFieldWidth) {
        ...
        getBSBObject().setTextFieldWidth(textFieldWidth);
