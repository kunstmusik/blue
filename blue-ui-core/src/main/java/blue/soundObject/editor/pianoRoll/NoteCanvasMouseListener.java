...
public class NoteCanvasMouseListener extends MouseAdapter {
        ...
        KeyboardFocusManager.getCurrentKeyboardFocusManager().addKeyEventDispatcher(key -> {
            if (dragMode == DragMode.NONE && mouseMoveNoteView != null) {
                ...
                if (c != Cursor.getPredefinedCursor(Cursor.E_RESIZE_CURSOR)
                    ...
                    if ((key.getModifiersEx() & OS_CTRL_KEY) == OS_CTRL_KEY && selectedFieldDef.getValue() != null) {
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (UiUtilities.isRightMouseButton(e)) {
            ...
            if (comp instanceof PianoNoteView noteView) {
                ...
                if ((e.getModifiersEx() & OS_CTRL_KEY) == OS_CTRL_KEY && selectedFieldDef.getValue() != null) {
                    ...
                    noteSourceData.setupData(selectedNotes, p.getScale());
                    mouseNote = note;
            ...
            } else if (((e.getModifiersEx() & OS_CTRL_KEY) == OS_CTRL_KEY) && !e.isShiftDown()) {
                // PASTE NOTES
            ...
            } else if (e.isShiftDown() && ((e.getModifiersEx() & OS_CTRL_KEY) != OS_CTRL_KEY)) {
                // DRAW NOTES
    ...
    private void pasteNotes(Point p) {
        ...
        if (!pianoRoll.isCompatible(sourcePianoRoll)) {
        ...
        double startTime = (double) x / pianoRoll.getPixelSecond();
    ...
    private void moveNotes(MouseEvent e) {
        ...
        final double baseAdjust = (double) diffX / pianoRoll.getPixelSecond();
    ...
    private void resizeNotesLeft(MouseEvent e) {
        ...
        final var snapEnabled = p.isSnapEnabled();
