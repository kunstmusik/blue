 ...
 * @author Steven Yi (modified for PianoRoll layout)
 */
public class PianoRollScrollPaneLayout extends ScrollPaneLayout {
    ...
    public static final String COLUMN_FOOTER_VIEW = "ColumnFooterView"; // NOI18N
    ...
    public void addLayoutComponent(String s, Component c) {
        switch (s) {
            ...
            case VERTICAL_BOTTOM:
                vbottom = c;
                break;
            case COLUMN_FOOTER_VIEW:
                fieldEditorViewPort = (JViewport) c;
                break;
            case SPLITTER:
                splitter = c;
                break;
    ...
    public void removeLayoutComponent(Component c) {
        if (c == hleft) {
            ...
            vbottom = null;
        } else if (c == fieldEditorViewPort.getView()) {
    ...
    public void layoutContainer(Container parent) {
        ...
        int splitterLocation = (Integer) scrollPane.getClientProperty("SplitterLocation");
        ...
        if (viewport != null) {
            ...
            availR.height -= splitterLocation;
        ...
        Rectangle fieldEditorRect = new Rectangle(availR.x,
                availR.y + availR.height + 5,
                availR.width, splitterLocation - 5);

        fieldEditorViewPort.setBounds(fieldEditorRect);

        /*
         * We now have the final size of the viewport: availR. Now fixup the
         * header and scrollbar widths/heights.
         */
        vsbR.height = availR.height + vpbInsets.top + vpbInsets.bottom + splitterLocation;
