...
package blue.projects.recentProjects;
...
public class RecentProjectsList {
    ...
    private static RecentProjectsList instance; // The single instance
    static {
     ...
     */
    public static RecentProjectsList getInstance() {
        return instance;
    }

    /** {@inheritDoc} */
    protected RecentProjectsList() {
        nodeName = "mrufiles";
    ...
    public void setRecentProjectsList(List<String> list) {
