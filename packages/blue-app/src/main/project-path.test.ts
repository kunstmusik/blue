...
import { canonicalProjectPathIdentity, isSameProjectPathIdentity } from './project-path';

describe('canonicalProjectPathIdentity', () => {
  it('preserves case on POSIX platforms', () => {
    expect(canonicalProjectPathIdentity('/Users/steven/Project.blue', 'darwin')).toBe(
      '/Users/steven/Project.blue',
    );
    expect(canonicalProjectPathIdentity('/home/blue/demo.blue', 'linux')).toBe(
      '/home/blue/demo.blue',
    );
  });
  ...
  it('resolves relative segments and redundant separators on POSIX', () => {
    expect(
      isSameProjectPathIdentity(
        '/Users/steven/work/../work/./demo.blue',
        '/Users/steven/work/demo.blue',
        'darwin',
      ),
    ).toBe(true);
    expect(
      isSameProjectPathIdentity('/Users//steven///demo.blue', '/Users/steven/demo.blue', 'darwin'),
    ).toBe(true);
    expect(isSameProjectPathIdentity('/Users/steven/work/', '/Users/steven/work', 'darwin')).toBe(
      true,
    );
  });
  ...
  it('computes identity for missing targets without file I/O', () => {
    ...
    expect(
      isSameProjectPathIdentity(missingWin, 'c:/users/steven/missing/DEMO.blue', 'win32'),
    ).toBe(true);
  });
  ...
  it('defaults to the host platform for identity rules', () => {
    ...
    const expected =
      hostPlatform === 'win32' ? 'c:\\users\\steven\\demo.blue' : '/Users/steven/Demo.blue';
    const input =
      hostPlatform === 'win32' ? 'C:/Users/steven/Demo.blue' : '/Users/steven/Demo.blue';
