...
const FIELD_LABEL_CLASS = 'mb-1 block text-xs font-medium text-app-text-muted';
const FIELD_DESCRIPTION_CLASS = 'mb-1.5 text-[11px] leading-4 text-app-text-subtle';
const FIELD_INPUT_CLASS =
  'w-full max-w-[400px] rounded-md border border-app-border bg-app-canvas px-2.5 py-1.5 text-[13px] text-app-text outline-none transition-colors placeholder:text-app-text-muted focus:border-app-accent disabled:cursor-not-allowed disabled:opacity-50';
const FIELD_SELECT_CLASS =
  'min-w-[140px] max-w-[400px] rounded-md border border-app-border bg-app-canvas px-2.5 py-1.5 text-[13px] text-app-text outline-none transition-colors focus:border-app-accent disabled:cursor-not-allowed disabled:opacity-50';
const FIELD_CHECKBOX_CLASS = 'mb-3 flex cursor-pointer items-start gap-2 text-[13px] text-app-text';
