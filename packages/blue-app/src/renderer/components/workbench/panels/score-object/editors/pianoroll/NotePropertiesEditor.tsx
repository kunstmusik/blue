...
export default function NotePropertiesEditor({
  ...
  return (
    <div className="flex items-center gap-2 min-w-0 flex-1">
      <label className="flex items-center gap-1 text-role-body text-app-text cursor-pointer shrink-0">
        <input
          type="checkbox"
      ...
      <input
        type="text"
        className="flex-1 min-w-0 rounded border border-blue-border bg-blue-bg px-2 py-0.5 text-role-body text-gray-100 font-mono focus:border-blue-accent focus:outline-none disabled:opacity-40"
        value={templateText}
