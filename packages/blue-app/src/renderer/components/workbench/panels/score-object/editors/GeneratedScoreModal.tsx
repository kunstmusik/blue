  ...
  return (
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="generated-score-title"
      ...
      >
        <div className="flex items-center justify-between border-b border-app-border px-4 py-3">
          <h2
            id="generated-score-title"
            className="text-role-title-2 font-bold text-app-text-bright"
          >
            Generated Score
          </h2>
          <button
            className="rounded p-1 text-role-body text-app-text-muted hover:bg-app-hover hover:text-app-text-bright focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-app-focus"
            onClick={onClose}
            aria-label="Close"
          >
            <X className="h-4 w-4" />
