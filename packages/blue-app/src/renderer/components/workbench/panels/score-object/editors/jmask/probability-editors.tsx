...
export function UniformEditor(): React.ReactElement {
  return (
    <div className="px-2 py-1 text-role-body text-blue-muted">Uniform — no additional controls</div>
  );
}
...
export function TriangleEditor(): React.ReactElement {
  return (
    <div className="px-2 py-1 text-role-body text-blue-muted">
      Triangle — no additional controls
    </div>
  );
}
...
export function ExponentialEditor({
  gen,
  onChange,
  duration,
}: {
  ...
  return (
    <div className="flex flex-col gap-1 px-2 py-1">
      <SelectInput
        label="Direction"
        value={direction}
        options={['Decreasing', 'Increasing', 'Bilateral']}
      ...
      <ConstantOrTable
        ...
        tableEnabled={lambdaTableEnabled}
        table={lambdaTable}
        duration={duration}
...
export function GaussianEditor({
  gen,
  onChange,
  duration,
}: {
  ...
  return (
    <div className="flex flex-col gap-1 px-2 py-1">
      ...
      <ConstantOrTable
        label="Sigma"
        constantValue={sigma}
        tableEnabled={sigmaTableEnabled}
        table={sigmaTable}
        duration={duration}
  ...
  return (
    <div className="flex flex-col gap-1 px-2 py-1">
      ...
      <ConstantOrTable
        label="Alpha"
        constantValue={alpha}
        tableEnabled={alphaTableEnabled}
        table={alphaTable}
        duration={duration}
...
export function renderProbabilitySubEditor(
  ...
  switch (kind) {
    ...
    case 'Linear':
      return <LinearEditor gen={gen} onChange={onChange} />;
    case 'Exponential':
      return <ExponentialEditor gen={gen} onChange={onChange} duration={duration} />;
    case 'Gaussian':
      return <GaussianEditor gen={gen} onChange={onChange} duration={duration} />;
    case 'Cauchy':
      return <CauchyEditor gen={gen} onChange={onChange} duration={duration} />;
    case 'Beta':
      return <BetaEditor gen={gen} onChange={onChange} duration={duration} />;
    case 'Weibull':
      return <WeibullEditor gen={gen} onChange={onChange} duration={duration} />;
    default:
      return <div className="px-2 py-1 text-role-body text-blue-muted">Unsupported: {kind}</div>;
  }
}
