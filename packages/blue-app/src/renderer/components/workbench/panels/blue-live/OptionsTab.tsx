  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', padding: '8px' }}>
      <label style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
        <span style={{ fontSize: 'var(--text-role-callout)', color: 'var(--color-app-text-muted)' }}>Command Line</span>
        <input
      ...
      <label style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        ...
        />
        <span style={{ fontSize: 'var(--text-role-body)', color: 'var(--color-app-text-muted)' }}>Command Line Enabled</span>
      </label>
      ...
      <label style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        ...
        />
        <span style={{ fontSize: 'var(--text-role-body)', color: 'var(--color-app-text-muted)' }}>Override (replaces CSD options)</span>
      </label>
    </div>
  );
}
