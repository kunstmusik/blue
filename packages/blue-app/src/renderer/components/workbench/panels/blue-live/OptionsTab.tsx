    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', padding: '8px' }}>
      <label style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
        ...
        <input
          ...
          onChange={(e) =>
            applyBlueLivePatch({ type: 'updateOptions', patch: { commandLine: e.target.value } })
          }
          style={inputStyle}
        />
      </label>
      ...
      <label style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        <input
          ...
          onChange={(e) =>
            applyBlueLivePatch({
              type: 'updateOptions',
              patch: { commandLineEnabled: e.target.checked },
            })
          }
        />
        <span
      ...
      <label style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        <input
          ...
          onChange={(e) =>
            applyBlueLivePatch({
              type: 'updateOptions',
              patch: { commandLineOverride: e.target.checked },
            })
          }
        />
        <span
