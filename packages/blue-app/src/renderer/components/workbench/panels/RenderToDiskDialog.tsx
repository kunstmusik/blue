    ...
    >
      ...
      >
        <div className="flex items-center justify-between border-b border-app-hover px-4 py-3">
          <h2 id="render-to-disk-title" className="text-sm font-medium text-app-text-bright" data-testid="render-dialog-title">
            {operationDialogTitle('Render to Disk', phase)}
          </h2>
        </div>

        <div className="min-h-0 flex-1 overflow-auto px-4 py-3">
          <table className="w-full border-collapse text-left text-sm text-app-text" data-testid="render-items-table">
            <thead>
        ...
        <div className="flex items-center justify-between gap-4 border-t border-app-hover px-4 py-3">
          <span className="min-w-0 truncate text-xs text-app-text-muted" data-testid="render-dialog-summary">
            {summary}
          </span>
