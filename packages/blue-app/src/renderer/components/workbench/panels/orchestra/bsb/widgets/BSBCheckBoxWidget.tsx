...
function BSBCheckBoxWidget({
  ...
  const labelText =
    typeof node.properties.label === 'string' ? node.properties.label : node.objectName;
    ...
    >
      <div
        ...
        style={{
          ...
          cursor: editEnabled ? 'default' : 'pointer',
      ...
      >
        ...
        <BsbTextLabel
          text={labelText}
          plainClassName="block text-role-callout"
          htmlClassName="inline-block max-w-full text-role-callout"
        />
      </div>
    </WidgetWrapper>
  );
