...
export function createArrangementColumns({
  ...
  return [
    ...
    columnHelper.accessor('assignmentId', {
      ...
      cell: (info) => (
        <input
          className="w-full rounded border border-blue-border bg-app-input px-1 py-0.5 font-mono text-role-body text-app-text outline-none focus:border-blue-accent"
    ...
    columnHelper.accessor('instrumentName', {
      ...
      cell: (info) => (
        <input
          className="w-full rounded border border-blue-border bg-app-input px-1 py-0.5 text-role-body text-app-text outline-none focus:border-blue-accent"
          defaultValue={info.getValue() || ''}
          placeholder="(unnamed)"
